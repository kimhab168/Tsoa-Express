    ...
    // ###########################################################################################################
        ...
        app.get('/v1/products',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    qry: {"in":"queries","name":"qry","required":true,"ref":"QueriesReqType"},
            };
        ...
        app.put('/v1/products/:id',
            ...(fetchMiddlewares<RequestHandler>(ProductController)),
            ...(fetchMiddlewares<RequestHandler>(ProductController.prototype.updateById)),

            async function ProductController_updateById(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
                    reqBody: {"in":"body","name":"reqBody","required":true,"ref":"ProductType"},
            };
